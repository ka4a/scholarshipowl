    ...
    */
    'managers'                   => [
        'default' => [
            ...
            'repository'    => \Pz\Doctrine\Rest\RestRepository::class,
            'proxies'       => [
                'namespace'     => false,
            ...
            */
            'mapping_types' => [
                // 'enum' => 'string'
                'json' => RecurrenceConfigType::NAME,
//                RecurrenceConfigType::NAME => RecurrenceConfigType::class,
            ]
        ],
    ],
    /*
    ...
    */
    'extensions'                 => [
        ...
        \App\Doctrine\Extensions\Uploadable\UploadableExtension::class,
    ...
    */
    'custom_string_functions'    => [
        \Scienta\DoctrineJsonFunctions\Query\AST\Functions\Mysql\JsonContains::FUNCTION_NAME =>
            \Scienta\DoctrineJsonFunctions\Query\AST\Functions\Mysql\JsonContains::class,
        \Scienta\DoctrineJsonFunctions\Query\AST\Functions\Mysql\JsonSearch::FUNCTION_NAME =>
            \Scienta\DoctrineJsonFunctions\Query\AST\Functions\Mysql\JsonSearch::class,
    ],
    /*
    |--------------------------------------------------------------------------
