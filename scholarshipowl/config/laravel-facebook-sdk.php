...
return [
    ...
    'applyme_facebook_config' => [
        'app_id' => env('FACEBOOK_APPLYME_APP_ID'),
        'app_secret' => env('FACEBOOK_APPLYME_APP_SECRET'),
     ...
     */
    'default_scope' => ['email', 'user_birthday', 'user_location'],

    /*
     * The default endpoint that Facebook will redirect to after
     * an authentication attempt.
     */
    'default_redirect_uri' => '/fb-callback#summary',
    ];
