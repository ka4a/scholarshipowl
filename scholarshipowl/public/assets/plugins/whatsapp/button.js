...
(function () {
    ...
    WASHAREBTN.prototype.addStyling = function () {
        var s = document.createElement("style"),
            c = "body{margin:0;}img{text-align: center;vertical-align: middle;max-width: 100%;height: auto;display: block;margin-left: auto;margin-right: auto;}";
    ...
    WASHAREBTN.prototype.crBtn = function () {
        ...
        if(!root.WASHAREBTN.buttons) root.WASHAREBTN.buttons = [];
...
function checkFrameSize() {
  var smsicon = document.getElementById('smsicon'),
    waframe = document.getElementById('waframe');

  if (waframe && smsicon) {
    waframe.height = smsicon.height;
  }
};
