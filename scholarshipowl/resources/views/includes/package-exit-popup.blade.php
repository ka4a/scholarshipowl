<div class="modal fade" id="package-exit-popup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body" id="package-exit-wizard">
			    <ul class="nav nav-pills">
                    <li class="active"><a href="#missionExitStep1" data-toggle="tab" data-step="1">Step 1</a></li>
                    <li><a href="#missionExitStep2" data-toggle="tab" data-step="2">Step 2</a></li>
                    <li><a href="#missionExitRafTab" data-toggle="tab" data-step="3">RAF</a></li>
                </ul>
			    <div class="tab-content">
			        <div role="tabpanel" class="tab-pane fade in active" id="missionExitStep1">
                        <div class="MissionOptionsDiv" data-url="" data-method="get" data-mission-id="">
                        </div>
                    </div>
                    <div role="tabpanel" class="tab-pane selectPayment fade in" id="missionExitStep2">
                        <div class="col-xs-12 col-sm-6 col-md-3 PackageDiv package" data-method="get">
                        </div>
                    </div>
                    <div role="tabpanel" class="tab-pane fade in congratulations-on-upgrading raf-monitor-popup modal-wide" id="missionExitRafTab">
                        <div class="row">
