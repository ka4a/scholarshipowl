...
@section("styles")
    ...
    {!! \App\Extensions\AssetsHelper::getCSSBundle('bundle16') !!}
@endsection
...
@section("scripts2")
    ...
    @endif
    {!! \App\Extensions\AssetsHelper::getJSBundle('bundle13') !!}
@endsection
...
@section('content')
    ...
    <div id="registration-form-step-3" class="register-step3-form">
        <form id="registerForm3" novalidate onsubmit="return false"
        class="ajax_form" method="POST" action="{{ url_builder('post-register3') }}"
              accept-charset="UTF-8" name="registerForm3" role="form">
            {{ Form::token() }}
                        ...
                        <div class="col-xs-12">
                            <div class="row">
                                <div class="form-wrapper center-block clearfix">
                                    @if(!is_mobile())
                                        <h3 class="sr-only" id="registration-form-step-3">Registration form - step
                                            3</h3>
                                        <div class="row">
                                                ...
                                                <div id="address" class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="address"
                                                               value="{{@$session['address']}}" class="form-control"
                                                ...
                                                <div id="address2" class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="address2"
                                                               value="{{@$session['address2']}}" class="form-control"
                                                ...
                                                <div id="stateSelect" class="form-group">
                                                    ...
                                                    @else
                                                        <input type="text" name="state_name"
                                                               value="{{@$session['state_name']}}" class="form-control"
                                                ...
                                                <div id="country" class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="country"
                                                               value="{{ account()->getProfile()->getCountry() }}"
                                                               readonly required>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div id="password" class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="password" name="password"
                                                               value="{{@$session['password']}}" class="form-control"
                    ...
                    <div class="container-fluid continue">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="prevNext">
                                    <a id="previous" href="{{ url_builder('register2') }}"
                                       class="prevNextBtn text-right pull-left mod-pull-left">
													<span>
														Back
													</span>
                                        <div class="arrow-btn">
                                    ...
                                    <div class="button-wrapper center-block btn-transition">
                                        <div class="btn btn-lg btn-block btn-warning text-uppercese text-center">
                                            <input value="continue" type="submit" class="Register3Button"
                                                   id="btnRegister3">
                                            <div class="arrow-btn btn-transition">
                                                <div class="arrow btn-transition">
                                                    <span class="a1"></span>
                                                    <span class="a2"></span>
                                                    <span class="a3"></span>
                                                    <span class="a4"></span>
                        ...
                        <aside role="complementary" aria-labelledby="testimonial">
                            <div class="clearfix apply-testimonial">
                                ...
                                <div class="static-testimonial clearfix">
                                    <blockquote>
                                        <p>Over 70% of respondents rated the overall experience with ScholarshipOwl as
                                            amazing</p>
                                    </blockquote>
                                </div>
                            </div>
